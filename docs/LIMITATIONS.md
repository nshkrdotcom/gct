...
- The primary result uses one 4B instruction model and one final prompt anchor. A negative result does
  not rule out scale-, family-, or post-training-dependent emergence.
